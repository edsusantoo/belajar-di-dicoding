...
class FakeDataDummyTest {
    companion object {
        fun generateDummyCourses(): ArrayList<CourseEntity> {
            val course = ArrayList<CourseEntity>()
        ...
        fun generateRemoteDummyContent(moduleId: String): ContentResponse {
            return ContentResponse(moduleId, "This a dummy test")
        }
        ...
        fun generateDummyCourseWithModules(course: CourseEntity, bookmarked: Boolean): CourseWithModule {
            ...
            courseWithModule.mCourse?.bookmarked = bookmarked
            courseWithModule.mModules = generateDummyModules(course.courseId)

            return courseWithModule
        }

        fun generateDummyContent(moduleId: String): ContentEntity {
            return ContentEntity("This a dummy content")
        }
