...
public class MediaService extends Service implements MediaPlayerCallback {
    ...
    public final static String ACTION_CREATE = "com.edsusantoo.bismillah.mymediaplayer.mediaservice.create";
    public final static String ACTION_DESTROY = "com.edsusantoo.bismillah.mymediaplayer.mediaservice.destroy";
